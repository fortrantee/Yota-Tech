...
@Mod("yotatech")
public class YotatechMod {
	public static final Logger LOGGER = LogManager.getLogger(YotatechMod.class);
	public static final String MODID = "yotatech";

...
public class YotatechModItems {
	...
	public static final RegistryObject<Item> YOTASULFURBLOK = block(YotatechModBlocks.YOTASULFURBLOK, YotatechModTabs.TAB_YOTA_CREATIVE_TAB_ORES);
	...
	public static final RegistryObject<Item> YOTA_ENERGY_ARROW = block(YotatechModBlocks.YOTA_ENERGY_ARROW, YotatechModTabs.TAB_YOTA_CREATIVE_TAB_ELECTRICITY);
	...
	public static final RegistryObject<Item> YOTA_CAPACITOR = block(YotatechModBlocks.YOTA_CAPACITOR, YotatechModTabs.TAB_YOTA_CREATIVE_TAB_ELECTRICITY);
	public static final RegistryObject<Item> YOTA_GALENA = block(YotatechModBlocks.YOTA_GALENA, YotatechModTabs.TAB_YOTA_CREATIVE_TAB_ORES);
	public static final RegistryObject<Item> YOTA_SPUDUMENE = block(YotatechModBlocks.YOTA_SPUDUMENE, YotatechModTabs.TAB_YOTA_CREATIVE_TAB_ORES);
	public static final RegistryObject<Item> YOTA_REALGAR = block(YotatechModBlocks.YOTA_REALGAR, YotatechModTabs.TAB_YOTA_CREATIVE_TAB_ORES);
